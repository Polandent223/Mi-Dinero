const CACHE='mi-dinero-p7-v1';
const ASSETS=['./','./index.html','./styles.css','./manifest.webmanifest','./icons/icon.svg','./src/app.js','./src/db.js','./src/security.js','./src/sync.js','./src/portfolio.js'];
