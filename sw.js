const CACHE='mi-dinero-p8-v1';
const ASSETS=['./','./index.html','./styles.css','./manifest.webmanifest','./icons/icon.svg','./src/startup-guard.js','./src/app.js','./src/db.js','./src/security.js','./src/sync.js','./src/portfolio.js','./src/wealth-ui.js'];
