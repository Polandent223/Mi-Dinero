...
const STORES = [
  ...
  'diagnosis','diagnosisHistory','transactions','recurringTransactions','budgets','leakReviews','reserves','debts','debtPlans','debtPayments','goals','contributions','plannedExpenses','investments','rates','purchaseAssessments','assets','liabilities','investmentContributions','portfolioSnapshots','backups'
];
...
export async function exportAll({includeBackups=false}={}){
  const data={schema:16,app:'Mi Dinero Personal',exportedAt:new Date().toISOString(),stores:{}};
